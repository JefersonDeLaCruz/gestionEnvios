    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="stats shadow">
            <div class="stat">
                ...
                <div class="stat-value text-primary"><?php echo e($totalPaquetes); ?></div>
        ...
        <div class="stats shadow">
            <div class="stat">
                ...
                <div class="stat-value text-secondary"><?php echo e($usuariosActivos); ?></div>
        ...
        <div class="stats shadow">
            <div class="stat">
                ...
                <div class="stat-value text-accent"><?php echo e($vehiculos); ?></div>
        ...
        <div class="stats shadow">
            <div class="stat">
                ...
                <div class="stat-value text-success">$<?php echo e(number_format($ingresosHoy, 2)); ?></div>
            ...
            <div class="overflow-x-auto">
                <table class="table table-zebra">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($activity->envio->paquete->codigo ?? 'N/A'); ?></td>
                            <td><?php echo e($activity->comentario ?? 'Sin descripción'); ?></td>
                            <td>
                                <span class="badge rounded-full badge-primary">
                                    <?php echo e($activity->estadoEnvio->nombre ?? 'Desconocido'); ?>
...
</div><?php /**PATH /var/www/html/gestionEnvios/resources/views/livewire/admin/dashboard.blade.php ENDPATH**/ ?>