<?php $__env->startSection('title', 'Login | PACXPRESS'); ?>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-897431323-0', null);
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-897431323-1', null);
    ...
    <div class="bg-base-100 min-h-screen flex flex-col justify-center items-center lg:flex-row text-base-content p-4 lg:p-0 overflow-hidden">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center lg:items-start px-4 lg:pl-10 max-w-2xl text-center lg:text-left">
            ...
            <div class="w-full max-w-[300px] flex flex-col gap-3 opacity-0 animate-enter delay-200">
                ...
                <a href="<?php echo e(route('home')); ?>" class="btn btn-ghost rounded-full">
                    Ir a Inicio
                </a>
...
<?php echo $__env->make('layout.base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/gestionEnvios/resources/views/login.blade.php ENDPATH**/ ?>