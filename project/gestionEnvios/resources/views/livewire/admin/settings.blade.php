<div class="p-6">
    ...
    <div class="tabs tabs-boxed mb-6 bg-base-200 p-2">
        ...
        <button wire:click="$set('activeTab', 'tipos-envio')" class="tab gap-2 {{ $activeTab === 'tipos-envio' ? 'tab-active' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="card bg-base-100 shadow-xl">
                            ...
                            <tr class="hover">
                                ...
                                <td>
                                    <div class="flex gap-2">
                                        ...
                                        <button wire:click="confirmDeleteTipoEnvio({{ $tipo->id }})" class="btn btn-ghost btn-sm text-error">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                            </svg>
                                        </button>
        ...
        <div class="modal modal-open">
            <div class="modal-box">
                <h3 class="font-bold text-lg mb-4">{{ $editTipoEnvioMode ? 'Editar Tipo de Envío' : 'Nuevo Tipo de Envío' }}</h3>
                ...
                <form wire:submit.prevent="saveTipoEnvio">
                    <div class="form-control mb-4">
                        ...
                        <input type="text" wire:model="tipoEnvioNombre" class="input input-bordered @error('tipoEnvioNombre') input-error @enderror" placeholder="Express, Estándar, etc." />
                    ...
                    <div class="form-control mb-4">
                        ...
                        <input type="number" wire:model="tipoEnvioPrioridad" class="input input-bordered @error('tipoEnvioPrioridad') input-error @enderror" placeholder="1" min="1" />
                    ...
                    <div class="grid grid-cols-1 gap-4 mb-4">
                        <div class="form-control">
                            ...
                            <input type="number" step="0.01" wire:model="tipoEnvioTarifaBase" class="input input-bordered @error('tipoEnvioTarifaBase') input-error @enderror" placeholder="0.00" />
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" step="0.01" wire:model="tipoEnvioTarifaPorKg" class="input input-bordered @error('tipoEnvioTarifaPorKg') input-error @enderror" placeholder="0.00" />
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" step="0.01" wire:model="tipoEnvioTarifaPorM3" class="input input-bordered @error('tipoEnvioTarifaPorM3') input-error @enderror" placeholder="0.00" />
                    ...
                    <div class="modal-action">
                        ...
                        <button type="submit" class="btn btn-primary">{{ $editTipoEnvioMode ? 'Actualizar' : 'Crear' }}</button>
                    </div>
                </form>
            </div>
