        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            ...
            <div class="stats shadow">
                <div class="stat">
                    ...
                    <div class="stat-value text-secondary">{{ $generalStats['avg_delivery_time'] }}h</div>
                </div>
            </div>
        </div>
    </div>
                ...
                <table class="table table-zebra">
                    ...
                    <tbody>
                        @forelse($deliveries as $delivery)
                            <tr class="hover">
                                <td class="font-mono text-sm">#{{ str_pad($delivery->id, 5, '0', STR_PAD_LEFT) }}</td>
                                <td>
                                ...
                                <td>
                                    <span class="badge badge-ghost badge-sm">{{ $delivery->vehiculo->placa ?? 'N/A' }}</span>
                                </td>
                                <td>
                                    @php
                                ...
                                <td>
                                    <div class="text-sm">{{ $delivery->created_at->format('d/m/Y') }}</div>
                                    <div class="text-xs text-base-content/70">{{ $delivery->created_at->format('H:i') }}</div>
                                </td>
                                ...
                                <td>
                                    <div class="flex gap-1">
                                        ...
                                        <button class="btn btn-ghost btn-xs" title="Historial">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
