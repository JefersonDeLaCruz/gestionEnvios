    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="tracking-code">
                ...
                <div class="code">{{ $paquete->codigo }}</div>
            ...
            <div class="info-section">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $paquete->descripcion }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Peso:</span>
                    <span class="info-value">{{ $paquete->peso }} kg</span>
                </div>
                @if($paquete->dimensiones)
                <div class="info-row">
                    <span class="info-label">Dimensiones:</span>
                    <span class="info-value">{{ $paquete->dimensiones }}</span>
                </div>
                @endif
                <div class="info-row">
                    <span class="info-label">Tipo de Envío:</span>
                    <span class="info-value">{{ ucfirst($paquete->tipoEnvio->nombre ?? 'N/A') }}</span>
                </div>
                @if($paquete->envio)
                <div class="info-row">
                    <span class="info-label">Fecha Estimada:</span>
                    <span class="info-value">{{ \Carbon\Carbon::parse($paquete->envio->fecha_estimada)->format('d/m/Y') }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Costo:</span>
                    <span class="info-value">${{ number_format($paquete->envio->costo, 2) }}</span>
                </div>
                @endif
            </div>
            ...
            <div class="info-section">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $otroCliente->nombre }} {{ $otroCliente->apellido }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Teléfono:</span>
                    <span class="info-value">{{ $otroCliente->telefono }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Dirección:</span>
                    <span class="info-value">{{ $otroCliente->direccion }}</span>
                </div>
            </div>

            @if($clienteTipo === 'receptor')
            <div class="alert">
