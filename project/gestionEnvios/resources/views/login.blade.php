        ...
        <div x-show="loginOpen" x-cloak style="display: none;" class="fixed inset-0 z-50 overflow-y-auto"
            ...
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="loginOpen" x-transition:enter="ease-out duration-300"
                    ...
                    class="inline-block align-bottom bg-base-100 rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-[600px] sm:w-full min-h-[600px] relative">
