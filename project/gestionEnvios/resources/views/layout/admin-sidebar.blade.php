<div class="drawer-side is-drawer-close:overflow-visible z-20">
    ...
    <div class="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-50 is-drawer-open:w-64 transition-all duration-300">
        <ul class="menu w-full grow gap-2 border-r border-base-300 pt-10">
            ...
            <li>
                <button class="flex is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Dashboard">
            ...
            <li>
                <button class="flex is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Envíos">
            ...
            <li>
                <button class="flex is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Usuarios">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="my-1.5 inline-block size-5">
            ...
            <li>
                <button class="flex is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Flota">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="my-1.5 inline-block size-5">
             ...
             <li>
                <button class="flex is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Reportes">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="my-1.5 inline-block size-5">
            ...
            <li>
                <button class="flex is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Configuración">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-linejoin="round"
                        stroke-linecap="round" stroke-width="2" fill="none" stroke="currentColor"
                        class="my-1.5 inline-block size-5">
