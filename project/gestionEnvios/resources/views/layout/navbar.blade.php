<div class="navbar bg-base-200 shadow-sm">
  ...
  <div class="navbar-end">
    <ul class="menu menu-horizontal px-1">
      <li>
        <a class="btn btn-ghost" href="https://github.com/JefersonDeLaCruz/gestionEnvios" target="_blank" aria-label="GitHub">
      ...
      <li>
        <a class="btn btn-ghost" aria-label="Toggle Theme">
